              ...
              <form ref={form} onSubmit={sendEmail}>
                ...
                <div className=" mb-6 flex items-center justify-center">
                  <input
                    type="submit"
                    value="Send"
                    className="text-gray-200 hover:text-white border border-gray-800 hover:bg-gray-800 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-black dark:focus:ring-white"
                  />
                </div>
              </form>
            </div>
